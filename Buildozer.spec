...
requirements = python3, kivy==2.2.1, pillow, numpy, docutils, matplotlib, kivy_matplotlib_widget, usb4a, usbserial4a, serial, scipy
...
android.permissions = WRITE_EXTERNAL_STORAGE, android.hardware.usb.host
