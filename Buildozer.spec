...
requirements = python3==3.11.3, kivy==2.2.1, pillow, datetime, contourpy, cycler, fonttools, kiwisolver, numpy, packaging, pyparsing, six, python-dateutil, matplotlib, kivy_matplotlib_widget, numpy
